...
export const SpecialsBanner: React.FC = () => {
  ...
  <div className="max-w-[1320px] mx-auto px-4 sm:px-gutter">
    <div className="rounded-xl bg-gradient-to-r from-surface-container via-surface-container-high to-surface-container p-6 sm:p-space-lg lg:p-space-xl shadow-[0_0_24px_rgba(212,175,55,0.15)] flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-space-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-space-md w-full lg:w-auto">
        <div className="p-5 sm:p-space-md rounded-xl bg-surface-container-lowest/80 flex flex-col gap-1 min-w-[170px]">
          ...
          <span className="font-serif font-normal text-2xl tracking-tight text-primary tabular-nums"><span className="text-sm align-top mr-0.5 opacity-80">₹</span>380</span>
        ...
        <div className="p-space-md rounded-xl bg-surface-container-lowest/80 flex flex-col gap-1 min-w-[170px]">
          ...
          <span className="font-serif font-normal text-2xl tracking-tight text-primary tabular-nums"><span className="text-sm align-top mr-0.5 opacity-80">₹</span>450</span>
        ...
        <div className="p-space-md rounded-xl bg-surface-container-lowest/80 flex flex-col gap-1 min-w-[170px]">
          ...
          <span className="font-serif font-normal text-2xl tracking-tight text-primary tabular-nums"><span className="text-sm align-top mr-0.5 opacity-80">₹</span>240</span>
