    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-space-xl mb-12 md:mb-space-xl">
      <div className="col-span-2 lg:col-span-1 flex flex-col gap-space-md">
        ...
        <div className="flex items-center gap-space-sm pt-space-xs">
          <a className="w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-on-surface-variant hover:border-[#D4AF37]/40 hover:text-[#D4AF37] transition-all" href="https://www.instagram.com/the_cafe_barrackpore?stkn=dmxjN2xuZGhtbTMw" target="_blank" rel="noopener noreferrer"><IconInstagram /></a>
          <a className="w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-on-surface-variant hover:border-[#D4AF37]/40 hover:text-[#D4AF37] transition-all" href="https://share.google/mAfX6gmsAoVhmRuJd" target="_blank" rel="noopener noreferrer"><IconFacebook /></a>
